...
namespace Atl_Inv_Server.Controller
{
    ...
    public class ReportsController : ControllerBase
    {
        ...
        public ReportsController(IWebHostEnvironment webHostEnvironment, IReportRepository reportRepository, ApplicationDbContext dbContext)
        {
        ...
        public async Task<IActionResult> GetProductReport(int reportType, string? productName)
        {
            try
            {
             ...
             //   var path = $"{this._webHostEnvironment.WebRootPath}Report\\reportOrderInfo.rdlc";
                var path = $"{this._webHostEnvironment.WebRootPath}\\Reports\\ProductInfo.rdlc";
